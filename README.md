...
## Gameplay 
*At the bottom, you will find the text input that is processed by the AI. You can switch between allies using the TAB key. You have 120 seconds to enter your text command.*
